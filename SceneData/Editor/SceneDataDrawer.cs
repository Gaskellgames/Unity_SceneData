...
namespace Gaskellgames.EditorOnly
{
    ...
    public class SceneDataDrawer : PropertyDrawer
    {
        ...
        {
            return showData ? (EditorGUIUtility.singleLineHeight + 2) * 5 : EditorGUIUtility.singleLineHeight;
        }
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            GUIContent newLabel = new GUIContent(label.text, string.IsNullOrEmpty(label.tooltip) ? tooltipSuffix : label.tooltip + "\n\n" + tooltipSuffix);
